...
export default {
    ...
    //   参数校验
        ...
        rulesForm:{
            ...
            evaluaInterval9:{trigger:'change',required:true,validator: evaluaInterval_one},evaluaInterval13:{trigger:'change',required:true,validator: evaluaInterval_one},
            ...
            evaluaInterval25:{trigger:'change',required:true,validator: evaluaInterval_one},evaluaInterval29:{trigger:'change',required:true,validator: evaluaInterval_one},
            evaluaInterval33:{trigger:'change',required:true,validator: evaluaInterval_one},  
            ...
            evaluaInterval10:{trigger:'change',required:true,validator: evaluaInterval_two},evaluaInterval14:{trigger:'change',required:true,validator: evaluaInterval_two},
            ...
            evaluaInterval26:{trigger:'change',required:true,validator: evaluaInterval_two},evaluaInterval30:{trigger:'change',required:true,validator: evaluaInterval_two},
            evaluaInterval34:{trigger:'change',required:true,validator: evaluaInterval_two},
            ...
            evaluaInterval11:{trigger:'change',required:true,validator: evaluaInterval_three},evaluaInterval15:{trigger:'change',required:true,validator: evaluaInterval_three},
            ...
            evaluaInterval27:{trigger:'change',required:true,validator: evaluaInterval_three},evaluaInterval31:{trigger:'change',required:true,validator: evaluaInterval_three},
            evaluaInterval35:{trigger:'change',required:true,validator: evaluaInterval_three},
            ...
            evaluaInterval12:{trigger:'change',required:true,validator: evaluaInterval_four},evaluaInterval16:{trigger:'change',required:true,validator: evaluaInterval_four},
    ...
    methods:{
        ...
        {classAssessItem:'AF0051801',appraItems:'AF005180103',assessWeightPoint:this.formdata.assessWeightPoint3,evakuaValue:'达标',evaluaIntervalStart:'0',evaluaIntervalEnd:this.formdata.evaluaInterval9,score:this.formdata.score7,assessDescrip:this.formdata.assessDescrip3,citycode:this.cityCode},
        ...
        {classAssessItem:'AF0051801',appraItems:'AF005180104',assessWeightPoint:this.formdata.assessWeightPoint4,evakuaValue:'达标',evaluaIntervalStart:'0',evaluaIntervalEnd:this.formdata.evaluaInterval13,score:this.formdata.score10,assessDescrip:this.formdata.assessDescrip4,citycode:this.cityCode},
        ...
        {classAssessItem:'AF0051802',appraItems:'AF005180201',assessWeightPoint:this.formdata.assessWeightPoint7,evakuaValue:'达标',evaluaIntervalStart:'0',evaluaIntervalEnd:this.formdata.evaluaInterval25,score:this.formdata.score19,assessDescrip:this.formdata.assessDescrip7,citycode:this.cityCode},
        ...
        {classAssessItem:'AF0051803',appraItems:'AF005180301',assessWeightPoint:this.formdata.assessWeightPoint8,evakuaValue:'达标',evaluaIntervalStart:'0',evaluaIntervalEnd:this.formdata.evaluaInterval29,score:this.formdata.score22,assessDescrip:this.formdata.assessDescrip8,citycode:this.cityCode},
        ...
        {classAssessItem:'AF0051803',appraItems:'AF005180302',assessWeightPoint:this.formdata.assessWeightPoint9,evakuaValue:'达标',evaluaIntervalStart:'0',evaluaIntervalEnd:this.formdata.evaluaInterval33,score:this.formdata.score25,assessDescrip:this.formdata.assessDescrip9,citycode:this.cityCode},
