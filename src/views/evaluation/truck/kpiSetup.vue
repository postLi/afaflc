...
export default {
    ...
    //   参数校验
        ...
        formdata:{
            ...
            evaluaInterval33:null, evaluaInterval31:null, evaluaInterval32:null, evaluaInterval36:null,
        ...
        rulesForm:{
            ...
            evaluaInterval26:{trigger:'change',required:true,validator: evaluaInterval_two},evaluaInterval28:{trigger:'change',required:true,validator: evaluaInterval_two},
            evaluaInterval32:{trigger:'change',required:true,validator: evaluaInterval_two},
            ...
            evaluaInterval16:{trigger:'change',required:true,validator: evaluaInterval_three},evaluaInterval23:{trigger:'change',required:true,validator: evaluaInterval_three},
    ...
    methods:{
        ...
        Addsave(){
        let form = [
        {classAssessItem:'AF0051801',appraItems:'AF005180101',assessWeightPoint:this.formdata.assessWeightPoint1,evakuaValue:'达标',evaluaIntervalStart:'0',evaluaIntervalEnd:this.formdata.evaluaInterval1,score:this.formdata.score1,assessDescrip:this.formdata.assessDescrip1},
        {classAssessItem:'AF0051801',appraItems:'AF005180101',assessWeightPoint:this.formdata.assessWeightPoint1,evakuaValue:'不达标',evaluaIntervalStart:this.formdata.evaluaInterval2,evaluaIntervalEnd:this.formdata.evaluaInterval3,score:this.formdata.score2,assessDescrip:this.formdata.assessDescrip1},
        {classAssessItem:'AF0051801',appraItems:'AF005180101',assessWeightPoint:this.formdata.assessWeightPoint1,evakuaValue:'严重不达标',evaluaIntervalStart:this.formdata.evaluaInterval4,evaluaIntervalEnd:this.formdata.evaluaInterval1,score:this.formdata.score3,assessDescrip:this.formdata.assessDescrip1},
        {classAssessItem:'AF0051802',appraItems:''},
