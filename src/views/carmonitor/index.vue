    ...
    <div style="position: relative;min-width: 1000px;min-height: 800px;width: 100%;height: 100%">
      ...
      <div ref="timeLineBar" class="timeLineBar" v-show="(activeTab===2)">
        <div style="width: 130px">
          <div class="playBtn" @click="playTrack"></div>
        </div>
        <!--div class="slow"></div>
          ...
          <div class="infoWindowTopDiv">
            <div style="display: flex;padding:15px 10px 20px;border-bottom: 1px solid rgb(238, 238, 238)">
              ...
              <div>
                <div style="display: flex;margin-top: 10px">
                  <div id="driverName" style="max-width: 100px;color: #f56c6c" class="ellipsis"></div>
                  <div id="driverMobile"
                       style="max-width: 100px;margin-left: 20px" class="ellipsis"></div>
            ...
            <div style="padding: 25px 10px 10px" id="orderDetail">
              <div style="display: flex">
                ...
                <div id="orderSerial" style="margin-left: 5px;max-width: 220px" class="ellipsis"></div>
...
<script>
  import {
    state, initMap, dateToString, escapeHtml, ellipsis, limitNumberInput,
    parseRouteToPath, convertTime, computeTime
